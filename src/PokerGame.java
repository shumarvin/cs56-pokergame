...
public class PokerGame {
    ...
    private JButton playButton, playAgainButton, howToPlayButton;
    ...
    */
	...
	howToPlayButton.addActionListener(new howToPlayButtonListener());
	panel.add(playButton,BorderLayout.CENTER);
	panel.add(howToPlayButton,BorderLayout.SOUTH);
    ...
    */
	...
	class howToPlayButtonListener implements ActionListener{
	    public void ActionPerformed(ActionEvent event){
